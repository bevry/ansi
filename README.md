...
``` typescript
import * as pkg from 'https://unpkg.com/@bevry/ansi@^3.5.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/@bevry/ansi@^3.5.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/@bevry/ansi@^3.5.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/@bevry/ansi@3.5.0'
</script>
```
